(()=>{
    ...
    var table = new Vue({
        ...
        //methods:{
        //    btn1(){
        //        document.getElementsByClassName("btn1").parentNode.parentNode.nextElementSibling.firstElementChild.classList.remove("none1").nextElementSibling.classList.add("none1");
        //    },
        //    btn2(){
        //        document.getElementsByClassName("btn2").parentNode.parentNode.nextElementSibling.firstElementChild.classList.remove("none1").nextElementSibling.classList.add("none1");
        //    }
        //}
    });
